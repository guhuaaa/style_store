# Op Art — UI translation

## Structure
Translate `perceptual rhythm` and `systematic repetition with controlled variation` into information hierarchy, grouping, and component geometry before ornament.
