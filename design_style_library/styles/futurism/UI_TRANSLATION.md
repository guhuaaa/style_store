# Futurism — UI translation

## Structure
Translate `directional velocity` and `sequential repetition` into layout, information hierarchy and component geometry before color or ornament.
