# Impressionism — UI translation

## Structure
Translate `transient light as hierarchy` and `broken neighboring color` into layout, information hierarchy and component geometry before color or ornament.
