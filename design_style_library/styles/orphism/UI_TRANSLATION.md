# Orphism — UI translation

## Structure
Translate `concentric or orbital rhythm` and `prismatic color simultaneity` into information hierarchy, grouping, and component geometry before ornament.
