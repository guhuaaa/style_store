# Hard-edge Painting — UI translation

## Structure
Translate `precise sharp-edged color planes` and `flat unmodulated fills` into information hierarchy, grouping, and component geometry before ornament.
