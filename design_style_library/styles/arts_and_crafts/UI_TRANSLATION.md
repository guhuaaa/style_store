# Arts and Crafts — UI translation

## Structure
Translate `truthful material-led structure` and `handmade repeat rhythm` into information hierarchy, grouping, and component geometry before ornament.
