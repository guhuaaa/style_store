# Color Field Painting — UI translation

## Structure
Translate `large unbroken chromatic fields` and `subtle edge breathing` into information hierarchy, grouping, and component geometry before ornament.
