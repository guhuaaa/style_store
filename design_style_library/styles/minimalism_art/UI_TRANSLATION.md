# Minimalism — UI translation

## Structure
Translate `serial modular reduction` and `literal material presence` into information hierarchy, grouping, and component geometry before ornament.
