# Romanticism — UI translation

## Structure
Translate `sublime scale contrast` and `atmospheric depth` into layout, information hierarchy and component geometry before color or ornament.
