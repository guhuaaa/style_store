# Suprematism — UI translation

## Structure
Translate `non-objective floating geometry` and `weightless white field` into layout, information hierarchy and component geometry before color or ornament.
