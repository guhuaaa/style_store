# Symbolism — UI translation

## Structure
Translate `allegorical focal image` and `suggestive rather than literal hierarchy` into information hierarchy, grouping, and component geometry before ornament.
