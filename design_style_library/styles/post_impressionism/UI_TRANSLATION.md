# Post-Impressionism — UI translation

## Structure
Translate `constructed color masses` and `expressive contour or faceting` into layout, information hierarchy and component geometry before color or ornament.
