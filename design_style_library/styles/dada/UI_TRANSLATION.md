...
## Structure
Translate `deliberate collision of found forms` and `disrupted type–image relationship` into layout, information hierarchy and component geometry before color or ornament.
