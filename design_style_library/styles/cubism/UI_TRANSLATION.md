# Cubism — UI translation

## Structure
Translate `simultaneous viewpoints` and `interlocking faceted planes` into layout, information hierarchy and component geometry before color or ornament.
