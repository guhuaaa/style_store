# Rococo — UI translation

## Structure
Translate `airy asymmetrical balance` and `shell-like curvilinear rhythm` into layout, information hierarchy and component geometry before color or ornament.
