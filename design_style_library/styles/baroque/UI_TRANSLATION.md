# Baroque — UI translation

## Structure
Translate `theatrical light–dark contrast` and `diagonal movement through depth` into layout, information hierarchy and component geometry before color or ornament.
